...
Source: arXiv:2402.17764 (pdftotext first-pass; ocrc parse supersedes when ready).
...
arXiv:2402.17764v1 [cs.CL] 27 Feb 2024
                                                  ...
                                                  optimized for 1-bit LLMs.
                                                   Performance
                                                                           ...
                                                                           BitNet b1.58 (This Work)                                                 Transformer LLMs
                                                                                          {-1, 0, 1}                                            16-bit Float (FP16/BF16)
                                                             ...
                                                             Y = f(W, X)         Model W                            Input X                       Output Y
                                                                        ...
                                                                        0.0413    0.3397        0.2812 0.2403         𝒙𝟏                                                            GPU
                                                                 FP16                                                                                …
...
Throughput We compare the throughput of BitNet b1.58 and LLaMA LLM with 70B parameters
...
size of LLaMA LLM, resulting an 8.9 times higher throughput.
       4
           https://github.com/EleutherAI/lm-evaluation-harness
                                                                        ...
                                                                        4
                                                                                                      BitNet b1.58
                       0.5       INT8 Add                                                101          LLaMA
                                 FP16 Add                                                                                                41.2x
7nm Energy Cost (pJ)   0.4       FP16 Mul
                                                                                         100
